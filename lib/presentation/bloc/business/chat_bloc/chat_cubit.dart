...
class ChatBusinessCubit extends Cubit<ChatBusinessState> {
  ...
  Future<void> getChats({bool resetPagination = true}) async {
    if (_isDisposed) return;
      ...
      if (response?.data != null) {
        ...
        if (data['status'] == true && data['data'] != null) {
          ...
          if (autogenerated.data?.chats != null) {
            ...
            if (kDebugMode) {
              print('Chats loaded successfully: ${chat.length} chats (hasMore: $_hasMoreChats)');
            }
          } else {
            if (resetPagination) {
              chat = [];
  ...
  Future<void> loadMoreChats() async {
    ...
    try {
      await getChats(resetPagination: false);
    } catch (e) {
      if (kDebugMode) {
