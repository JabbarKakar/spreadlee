...
class AudioMessageCustomerWidget extends StatefulWidget {
  ...
  const AudioMessageCustomerWidget({
    Key? key,
  ...
  @override
  State<AudioMessageCustomerWidget> createState() =>
      _AudioMessageCustomerWidgetState();
}

class _AudioMessageCustomerWidgetState
    extends State<AudioMessageCustomerWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    try {
      ...
      if (kDebugMode) {
        print(
            'AudioMessageCustomerWidget: ChatProviderInherited not available: $e');
      }
      currentStatus = null;
    }
