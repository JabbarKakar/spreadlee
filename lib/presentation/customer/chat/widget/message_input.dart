...
import 'package:spreadlee/presentation/customer/chat/view/location_picker_screen.dart';
...
class MessageCustomerInput extends StatefulWidget {
  final TextEditingController controller;
  final bool isCustomer;
  final bool isTicketChat;

  const MessageCustomerInput(
      {Key? key,
  ...
  @override
  State<MessageCustomerInput> createState() => _MessageCustomerInputState();
}

class _MessageCustomerInputState extends State<MessageCustomerInput>
  ...
  void _handleStatusUpdate(MessageStatusUpdate update) {
    if (kDebugMode) {
      print('MessageCustomerInput: Status update received: ${update.type}');
  ...
  void _onTextChanged() {
    // Trigger UI rebuild to update send button state
    setState(() {});
  }
                ...
                if (!isAudioRecording &&
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      onChanged: (text) {
                        // Handle text changes without typing indicators
                      },
                            ...
                            final result =
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                  ...
                                  value: chatProvider,
                                  child: LocationPickerCustomerScreen(
                                    chatId: chatProvider?.chatId ?? '',
