...
class LocationPickerCustomerScreen extends StatefulWidget {
  final String chatId;
  final String userId;
  final String userRole;

  const LocationPickerCustomerScreen({
    Key? key,
  ...
  @override
  State<LocationPickerCustomerScreen> createState() =>
      _LocationPickerCustomerScreenState();
}

class _LocationPickerCustomerScreenState
    extends State<LocationPickerCustomerScreen> {
  ...
  Future<void> _sendLocation() async {
    ...
    try {
      ...
      debugPrint('=== Location data prepared (Customer): $location ===');
      ...
      if (mounted) {
        debugPrint(
            '=== Navigating back to chat with location data (Customer) ===');
        Navigator.pop(context, {
          'success': true,
          'location': location,
        });
