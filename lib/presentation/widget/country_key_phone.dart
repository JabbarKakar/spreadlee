...
int? calculateTimeDiffMilliseconds(
  DateTime firstDate,
  DateTime secondDate,
) {
  DateTime modifiedFirstDate = firstDate.add(const Duration(milliseconds: 120000));
  int differenceInMilliseconds =
      modifiedFirstDate.difference(secondDate).inMilliseconds;
  return differenceInMilliseconds;
}

int? calculateTimeDiffMinutes(
  DateTime dateTime1,
  DateTime dateTime2,
) {
...
List<dynamic>? getPhoneNumberCountriesLists() {
  return [
...
String decodeStringInBase64(String string) {
  return utf8.fuse(base64).decode(string);
}

List<dynamic>? getPhoneNumberCountriesListSpreadLee(String? search) {
...
List<dynamic> searchCountryByName(String searchingText) {
  List<dynamic>? countries = getPhoneNumberCountriesLists();
...
String? generatePassword() {
  // сгенерировать строку из 8 символов английского алфавита любого регистра
  String result = '';
...
String encodeStringInBase64(String string) {
  return utf8.fuse(base64).encode(string);
}
