...
class PhotoHive extends StatefulWidget {
  const PhotoHive({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<PhotoHive> createState() => _PhotoHiveState();
}

class _PhotoHiveState extends State<PhotoHive>
  ...
  @override
  void didUpdateWidget(PhotoHive oldWidget) {
  ...
  Future<void> _downloadAndSavePhoto() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Error caching photo: $e'),
