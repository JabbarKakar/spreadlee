...
class ContactUsBusinessScreen extends StatelessWidget {
  const ContactUsBusinessScreen({Key? key}) : super(key: key);
      ...
      body: Column(
        children: [
          ...
          _buildContactOption(
            ...
            onTap: () =>
                Navigator.pushNamed(context, Routes.ticketsBusinessRoute),
          ),
          _buildContactOption(
