...
class InvoiceReleaseWidget extends StatefulWidget {
  ...
  @override
  State<InvoiceReleaseWidget> createState() => _InvoiceReleaseWidgetState();
}

class _InvoiceReleaseWidgetState extends State<InvoiceReleaseWidget> {
  ...
  double _calculateTotal() {
    return _calculateSubtotal() + _calculateVatAmount();
  }
  ...
  Future<void> _submitInvoice() async {
    ...
    try {
      final invoiceData = {
        ...
        'currency': 'SAR',
        // Bank details are optional and will be added only if provided
      };
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'SAR ${_calculateSubtotal().toStringAsFixed(2)}',
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyMedium
                                    ?.copyWith(
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'SAR ${_calculateVatAmount().toStringAsFixed(2)}',
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyMedium
                                    ?.copyWith(
