    ...
    if (widget.message.isTemp == true &&
      ...
      _tryGetLocalFileSize().then((_) {
        if (mounted) {
          ...
          print('🔧 Temporary message force initialized successfully');
        }
      }).catchError((e) {
            ...
            child: Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Icon(
                    messageStatus == 'read' || messageStatus == 'delivered' || widget.message.isDelivered == true || widget.message.isRead == true
                        ? Icons.done_all // Double check for delivered/read
                        : Icons.check, // Single check for sent
                    size: 16,
                    color: messageStatus == 'read' || widget.message.isSeen == true || widget.message.isRead == true
