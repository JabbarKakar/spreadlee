...
class MessageInvoiceWidget extends StatefulWidget {
  ...
  @override
  State<MessageInvoiceWidget> createState() => _MessageInvoiceWidgetState();
}

class _MessageInvoiceWidgetState extends State<MessageInvoiceWidget>
  ...
  @override
  void didUpdateWidget(covariant MessageInvoiceWidget oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    // Don't show error state - just return empty widget if no invoice data
    if (_invoiceData == null) {
      return const SizedBox.shrink();
    }
                          ...
                          children: [
                            _buildActionButton('View', onPressed: () async {
                              ...
                              try {
                                ...
                                final chatCubit =
                                    context.read<ChatBusinessCubit>();
