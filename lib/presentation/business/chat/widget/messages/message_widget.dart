...
import 'package:spreadlee/presentation/business/chat/widget/messages/audio_message_widget.dart';
import 'package:spreadlee/presentation/business/chat/widget/messages/document_message_widget.dart';
import 'package:spreadlee/presentation/business/chat/widget/messages/location_message_widget.dart';
import 'package:spreadlee/presentation/business/chat/widget/messages/message_invoice_widget.dart';
import 'package:spreadlee/presentation/business/chat/widget/messages/photo_message_widget.dart';
import 'package:spreadlee/presentation/business/chat/widget/messages/text_message_widget.dart';
import 'package:spreadlee/presentation/business/chat/widget/messages/video_message_widget.dart';
...
class MessageWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (message.location != null && message.location!.isNotEmpty) {
      messageWidget = LocationMessageWidget(
        message: message,
      ...
      messageWidget = BusinessPhotoMessageWidget(
        message: message,
        isFromUser: isFromUser,
        lastReadMessageDate: lastReadMessageDate,
      ...
      messageWidget = DocumentMessageWidget(
        ...
        (message.messageText != null &&
            ...
            _hasInvoiceRef(message.invoiceData))) {
      messageWidget = MessageInvoiceWidget(
        message: message,
        isFromUser: isFromUser,
        lastReadMessageDate: lastReadMessageDate,
        onViewTap: (invoice) {
